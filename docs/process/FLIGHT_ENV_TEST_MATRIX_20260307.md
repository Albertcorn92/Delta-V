...
| Thermal cycle (software proxy) | `tools/sitl_soak.py` | SITL binary | 60 s soak in software_final gate | Required markers present, no fatal signatures | PASS | `docs/SOFTWARE_FINAL_STATUS.md`, `docs/evidence/SIM_OPERATIONS_EVIDENCE_20260307.md` | Framework maintainer | 2026-03-07 |
