...
| Safety-criticality determination | Repository identifies safety-significant paths, but mission hazard approval and final criticality determination remain mission-owned. | PARTIAL | `docs/process/SOFTWARE_SAFETY_PLAN_BASELINE.md`, `docs/safety_case/` |
| Project-approved tailoring matrix | Repository documents intentional scope deviations, but does not provide an authority-approved applicability/tailoring decision set. | OPEN / MISSION-OWNED | `docs/process/TAILORING_AND_SCOPE_DEVIATIONS_BASELINE.md` |
...
| Formal inspection / review closure | Review records and change-control artifacts exist, but they are not equivalent to project-governed formal inspection closure under an external authority chain. | PARTIAL | `docs/process/INDEPENDENT_REVIEW_RECORD_20260307.md`, `docs/process/CCB_RELEASE_SIGNOFF_20260307.md` |
...
| Tool qualification / deviation approval | Tool governance baseline exists, but no formal tool qualification or authority-approved deviation package is claimed. | PARTIAL | `docs/process/TOOL_GOVERNANCE_BASELINE.md`, `docs/process/STATIC_ANALYSIS_DEVIATION_LOG.md` |
