...
- [ ] Coverage guard passes in dedicated GCC coverage build (`cmake --build build_cov --target coverage_guard`).
...
- [ ] Runtime metric guard passes (`python3 tools/esp32_runtime_guard.py ...`).
- [ ] Reboot campaign passes (`python3 tools/esp32_reboot_campaign.py ...`).
